        ...
        <>
          ...
          <div className="cart-lower flex justify-between items-start py-10">
            <button
              ...
              className="clear-btn uppercase border py-3 px-8
        hover:bg-rose-200 hover:text-rose-600 font-medium hover:border-rose-200 duration-300"
            >
              clear cart
            </button>
